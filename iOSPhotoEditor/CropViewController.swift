...
open class CropViewController: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        if self.toolbarItems == nil {
            ...
            let constrainButton = UIBarButtonItem(title: "Dimensioni", style: .plain, target: self, action: #selector(CropViewController.constrain(_:)))
    ...
    @objc func constrain(_ sender: UIBarButtonItem) {
        ...
        let original = UIAlertAction(title: "Originale", style: .default) { [unowned self] action in
        ...
        let square = UIAlertAction(title: "Quadrato", style: .default) { [unowned self] action in
...
//            self.cropView?.cropAspectRatio = ratio
        ...
        let cancel = UIAlertAction(title: "Annulla", style: .default) { [unowned self] action in
